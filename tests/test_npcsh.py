...
def test_npcsh():
    ...
    npcsh.expect("foreman>")
    print("Test 3 passed: weather_jinx executed successfully.")
    time.sleep(1)

    # Test 4: Test calculator jinx
    npcsh.sendline("Calculate the sum of 2 and 3.")
    npcsh.expect("The result of .* is 5", timeout=30)
    npcsh.expect("foreman>")
    print("Test 4 passed: calculator jinx executed successfully.")
    time.sleep(1)

    # Test 5: Test database_query jinx
    npcsh.sendline("Find all users with the role 'admin'.")
    npcsh.expect("Here are the results:", timeout=30)
    npcsh.expect("foreman>")
    print("Test 5 passed: database_query jinx executed successfully.")
    time.sleep(1)
